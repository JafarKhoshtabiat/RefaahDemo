...
class RegistrationFlowView_TextField_NextButton: RegistrationFlowView_NextButton {
    ...
    private var textFieldTopConstraint: NSLayoutConstraint = NSLayoutConstraint()
    ...
    private func createSubviews() {
        ...
        let textFieldTopConstraint = NSLayoutConstraint(item: self.textField, attribute: .top,
                                                                        relatedBy: .equal,
                                                                        toItem: promptLabel, attribute: .bottom,
                                                                        multiplier: 1, constant: 20)
        let textFieldRightConstraint = NSLayoutConstraint(item: self.textField, attribute: .right,
                                                                          relatedBy: .equal,
                                                                          toItem: promptLabel, attribute: .right,
                                                                          multiplier: 1, constant: 0)
        let textFieldCenterXConstraint = NSLayoutConstraint(item: self.textField, attribute: .centerX,
                                                                            relatedBy: .equal,
                                                                            toItem: self, attribute: .centerX,
                                                                            multiplier: 1, constant: 0)
        let textFieldHeightConstraint = NSLayoutConstraint(item: self.textField, attribute: .height,
                                                                           relatedBy: .equal,
                                                                           toItem: nil, attribute: .height,
                                                                           multiplier: 0, constant: 50)
        self.addConstraints([textFieldTopConstraint,
                             textFieldRightConstraint,
                             textFieldCenterXConstraint,
        ...
        self.textFieldTopConstraint = textFieldTopConstraint
    }
}
...
extension RegistrationFlowView_TextField_NextButton: RegistrationFlowView_TextField_NextButton_Protocol {
    ...
    func updateTextFieldTopConstraint(newConstraint: NSLayoutConstraint) {
        self.removeConstraint(self.textFieldTopConstraint)
        self.addConstraint(newConstraint)
        self.textFieldTopConstraint = newConstraint
    }
}
